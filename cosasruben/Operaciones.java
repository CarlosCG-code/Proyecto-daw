...
public class Operaciones {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    if (rellenado) {
                        ...
                        System.out.println("La suma de los valores de la fila " + (fila + 1) + " es: " + sumaFila(matriz, fila));
    ...
    public static int sumaDiagonalInversa(int[][] matriz) {
        ...
        for (int i = 0, j = matriz[0].length - 1; i < matriz.length - 1; i++, j--) {
            suma += matriz[i][j];
        }
